        ...
        <div className="w-[90%] mx-auto grid gap-5">
            ...
            <table className="w-full h-[90%] ">
                    <tr className="h-[5%] ">
                      ...
                      <th className="w-[30%]"><img class="lg:w-[40%] w-[90px] mx-auto" src={uniswap} alt="uniswap logo"/></th>
                    </tr>
                    <tr >
                      ...
                      <td className=" border-r border-b border-t border-[#D9D9D91A] "><img class="mx-auto w-[30px]"  src={check} alt="check icon"/></td>
                      <td className="border-r border-b border-t border-[#D9D9D91A] "><img class="mx-auto w-[38px]"  src={close} alt="close icon"/></td>
